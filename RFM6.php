...
<a href ="welcome.html"> <img height="80px" width="110px" src="MOS01.png"></a>
   ...
   <input type="button" class="stock_txt" value="上一頁" onclick="location.href='RFM..php';"/>	
...
$(document).ready(function() {  
   ...
   var series= [{
      name: '損益平衡指數',
            data: [339, 335, 333, 330, 325, 320, 310, 302, 298, 280, 270, 263, -60, 262, -50, 250, 243, -49, -45, -50, -52, -59, -60, -65, -63, -62, -64]
        }
   ];     
